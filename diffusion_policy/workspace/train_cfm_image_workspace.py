...
from diffusion_policy.policy.cfm_unet_image_policy import CFMUnetImagePolicy
...
class TrainCFMUnetImageWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        np.random.seed(seed)
        random.seed(seed)
        self.model: CFMUnetImagePolicy = hydra.utils.instantiate(cfg.policy)
        self.ema_model: CFMUnetImagePolicy = None
...
def main(cfg):
    workspace = TrainCFMUnetImageWorkspace(cfg)
    workspace.run()
