...
## 5. Full checkpoint x selection x n grid

Every `step_*.ckpt` on the 10k grid x {argmax, softmax, final_pass} x n in {1,2,4,8,16}, both arms. **4/60 combos complete -- sweep still running, table is partial.**
...
| checkpoint | selection | n=1 | n=2 | n=4 | n=8 | n=16 |
|---|---|---|---|---|---|---|
| 10,000 | argmax | 0.486 | 0.634 | 0.757 | 0.801 | 0.797 |
| 10,000 | softmax | 0.477 | 0.688 | 0.694 | 0.769 | 0.777 |
| 10,000 | final_pass | 0.616 | 0.693 | 0.581 | 0.626 | 0.643 |

### SEARCH  --  test success

| checkpoint | selection | n=1 | n=2 | n=4 | n=8 | n=16 |
|---|---|---|---|---|---|---|
| 10,000 | argmax | 0.060 | 0.160 | 0.320 | 0.360 | 0.400 |
| 10,000 | softmax | 0.120 | 0.260 | 0.160 | 0.160 | 0.200 |
| 10,000 | final_pass | 0.080 | 0.140 | 0.120 | 0.100 | 0.120 |

### SEARCH  --  val reward

| checkpoint | selection | n=1 | n=2 | n=4 | n=8 | n=16 |
|---|---|---|---|---|---|---|
| 10,000 | argmax | 0.478 | 0.713 | 0.796 | 0.763 | 0.788 |
| 10,000 | softmax | 0.546 | 0.696 | 0.679 | 0.746 | 0.779 |
| 10,000 | final_pass | 0.653 | 0.666 | 0.689 | 0.605 | 0.628 |

### SEARCH  --  val success

| checkpoint | selection | n=1 | n=2 | n=4 | n=8 | n=16 |
|---|---|---|---|---|---|---|
| 10,000 | argmax | 0.067 | 0.067 | 0.233 | 0.467 | 0.333 |
| 10,000 | softmax | 0.100 | 0.067 | 0.200 | 0.200 | 0.200 |
| 10,000 | final_pass | 0.133 | 0.100 | 0.100 | 0.000 | 0.167 |
