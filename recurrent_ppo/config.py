...
DEFAULTS = {
    ...
    "log_std_init": -1.0,
    "net_arch": "128,128",
    # the Q head is a deliverable of the clean arm, so its shape is a choice like any other
    "q_net_arch": "128,128",
    "q_lr": 1e-3,
    ...
    "log_interval": 10_000,
    "save_freq": 100_000,
    # not 0: with it off there is no eval/ series at all, only the training return
    "eval_freq": 100_000,
    "video_freq": 24,
    "video_length": 300,
    "video_episodes": 1,
